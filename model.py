...
class VaeArx(nn.Module):
    def __init__(self, input_dim, output_dim, latent_dim, layer_dim, regressor_dim):
        """Initialize VaeArx Model.
        ...
        self.dec1 = nn.Linear(latent_dim+regressor_dim, layer_dim)
    ...
    def forward(self, obs):
        q = obs[:,-self.regressor_dim:].reshape(obs.size(0), self.regressor_dim)
        obs = obs[:,0:-self.regressor_dim]
